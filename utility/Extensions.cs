...
public static class MyExtensions
{
    ...
    /// </summary>
    /// <returns></returns>
    public static string Decimal_NumberOf(int num)
    {
        string ReturnValue = "";
        for (int i = 0; i < num; i++)
        {
    ...
    public static decimal ToDecimal(this string str, int decimals,int type = 0)
    {
        if (type == 1)
        {
            decimal test;
        ...
        else
        {
            ...
            {
                decimal.Round(test, decimals, MidpointRounding.AwayFromZero);
                ReturnValue = test.ToString();
            }
            if (decimals > 0)
            {
                ReturnValue = test.ToString("#0." + Decimal_NumberOf(decimals));
            }
    ...
    {
        return BPM.Utility.Encryption.Encrypt(str);
    }
    /// <summary>
    /// AES解密字符串
    /// </summary>
    ...
    {
        return BPM.Utility.Encryption.Decrypt(str);
    }
    ...
    {
        return BPM.Utility.EncryptionDes.Encrypt(str);
    }
    /// <summary>
    /// DES解密字符串
    /// </summary>
    ...
    {
        return BPM.Utility.EncryptionDes.Decrypt(str);
    }
    ...
    {
        return date.ToDateTime().ToString(BPM.Utility.Config.DateFormat);
    }

    public static string ToDateTimeString(this string dateTime)
    {
        return dateTime.ToDateTime().ToString(BPM.Utility.Config.DateTimeFormat);
    }

    public static string ToDateTimeStringS(this string dateTime)
    {
        return dateTime.ToDateTime().ToString(BPM.Utility.Config.DateTimeFormatS);
    }

    public static string ToDateString(this DateTime date)
    {
        return date.ToString(BPM.Utility.Config.DateFormat);
    }

    public static string ToDateTimeString(this DateTime dateTime)
    {
        return dateTime.ToString(BPM.Utility.Config.DateTimeFormat);
    }

    public static string ToDateTimeStringS(this DateTime dateTime)
    {
        return dateTime.ToString(BPM.Utility.Config.DateTimeFormatS);
    }
}
